...
/**
 * Responsible for discovering the drones - taken from samples (com.parrot.sdksample.discovery)
 */
public class DroneDiscoverer {
    private static final String TAG = DroneDiscoverer.class.getSimpleName();
